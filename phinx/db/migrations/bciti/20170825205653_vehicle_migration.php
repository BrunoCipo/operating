...
class VehicleMigration extends AbstractMigration
{
    ...
    public function change(){
    	...
    	$this->vCreateVehicle();
    	$this->vCreateVehicleBrand();
    }
	
	private function vCreateVehicle(){
		
		$this->table('Vehicle', [ 'id'=> false, 'primary_key' => [ 'id' ] ] )
	...
	private function vCreateVehicleBrand(){
		
		$this->table('VehicleBrand', [ 'id'=> false, 'primary_key' => [ 'id' ] ] )
			->addColumn('id',                   'biginteger',   [ 'identity'  => true ] )
