...
class KbMigration extends AbstractMigration
{
	...
	protected function vCreateKBFileTable(){
		...
		$this->table('KBFile', [ 'id'=> false, 'primary_key' => [ 'id' ] ] )
			...
			->addColumn('sBody',                        'string',       [ 'null'    => true,    'length'    => 1073741823  ] )
			->addColumn('sTitleEn',                     'string',       [ 'null'    => true,    'length'    => 1073741823  ] )
			->addColumn('sBodyEn',                      'string',       [ 'null'    => true,    'length'    => 1073741823  ] )
			...
			->addColumn('sSeasonIdList',                'string',       [ 'null'    => true,    'length'    => 1073741823  ] )
			->addColumn('sMonthIdList',                 'string',       [ 'null'    => true,    'length'    => 1073741823  ] )
			->addColumn('sValidation',                  'string',       [ 'null'    => true,    'length'    => 1073741823  ] )
			->addColumn('sInternalProcedure',           'string',       [ 'null'    => true,    'length'    => 1073741823  ] )
			...
			->addColumn('sKeywords',                    'string',       [ 'null'    => true,    'length'    => 1073741823  ] )
			->addColumn('sKeywordsEn',                  'string',       [ 'null'    => true,    'length'    => 1073741823  ] )
	...
	protected function vCreateKBFileJournalisationTable(){
		...
		$this->table('KBFileJournalisation', [ 'id'=> false, 'primary_key' => [ 'id' ] ] )
			...
			->addColumn('sInternalProcedure',           'string',       [ 'null'    => true,    'length'    => 1073741823   ] )
			->addColumn('iInterventionTypeId',          'biginteger',   [ 'null'    => true   ] )
			->addColumn('sInternalReferences',          'string',       [ 'null'    => true,    'length'    => 1073741823   ] )
			->addColumn('sExternalReferences',          'string',       [ 'null'    => true,    'length'    => 1073741823   ] )
			->addColumn('sUrl',                         'string',       [ 'null'    => true,    'length'    => 1073741823   ] )
			->addColumn('bDeletedCopy',                 'integer',      [ 'null'    => true   ] )
			->addColumn('iModificationCopy',            'biginteger',   [ 'null'    => true   ] )
			->addColumn('sResponsableList',             'string',       [ 'null'    => true,    'length'    => 1073741823   ] )
			->addColumn('sArborescenceNameList',        'string',       [ 'null'    => true,    'length'    => 1073741823   ] )
	...
	protected function vCreateKBObjectRecuperationTable(){
		...
		$this->table('KBObjectRecuperation', [ 'id'=> false, 'primary_key' => [ 'id' ] ] )
			...
			->addColumn('sInfoSupp',                    'string',       [ 'null'    => true,    'length'    => 1073741823   ] )
	...
	protected function vCreateKBOntologyTable(){
		...
		$this->table('KBOntology', [ 'id'=> false, 'primary_key' => [ 'id' ] ] )
			...
			->addColumn('sNameFr',                      'string',       [ 'null'    => true,    'length'    => 1073741823   ] )
			->addColumn('sNameEn',                      'string',       [ 'null'    => true,    'length'    => 1073741823   ] )
			->addColumn('sUri',                         'string',       [ 'null'    => true,    'length'    => 1073741823   ] )
			->addColumn('sJsonSynonymes',               'string',       [ 'null'    => true,    'length'    => 1073741823   ] )
	...
	protected function vCreateKBRecuperateurObjectAssociationTable(){
		...
		$this->table('KBRecuperateurObjectAssociation', [ 'id'=> false, 'primary_key' => [ 'id' ] ] )
			...
			->addColumn('fkiOntologyId',                'biginteger',   [ 'null'    => true ] )
			->addColumn('fkiRecuperateurId',            'biginteger',   [ 'null'    => true ] )
			->addColumn('sModalite',                    'string',       [ 'null'    => true,    'length'    => 1073741823 ] )
	...
	protected function vCreateKBSignalementTable(){
		...
		$this->table('KBSignalement', [ 'id'=> false, 'primary_key' => [ 'id' ] ] )
			...
			->addColumn('sMessage',                     'string',       [ 'null'    => true,    'length'    => 1073741823 ] )
