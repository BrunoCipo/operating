...
class TagMigration extends AbstractMigration
{
    ...
    public function change(){
    	...
    	$this->vCreateTag();
    	$this->vCreateTagAssociation();
    }
	
	private function vCreateTag(){
	...
	private function vCreateTagAssociation(){
		
		$this->table('TagAssociation', [ 'id'=> false, 'primary_key' => [ 'id' ] ] )
			->addColumn('id',                           'biginteger',   [ 'identity'  => true ] )
			
			->addColumn('fkiTagId',                     'biginteger',   [ 'null'    => false ] )
			...
			->addIndex(     'bDeleted',                     [ 'name' => 'idx_deleted' ] )
			->addIndex(     'fkiTagId',                     [ 'name' => 'idx_tag' ] )
			->addIndex(     [   'sModelName',
