...
class ApiMigration extends AbstractMigration{
	...
	protected function vCreateApiDocTable(){
		...
		$this->table('ApiDoc', array('id'=> false, 'primary_key' => array('id')))
			...
			->addColumn('sDescription',         'string',       array('null'    => true, 'length' => 1073741823 ))
			->addColumn('sAutoTestUrl',         'string',       array('null'    => true, 'length' => 1073741823 ))
			->addColumn('sInfo',                'string',       array('null'    => true, 'length' => 1073741823 ))
			->addColumn('sDataToServerExample', 'string',       array('null'    => true, 'length' => 1073741823 ))
			->addColumn('sResponseExample',     'string',       array('null'    => true, 'length' => 1073741823 ))
	...
	protected function vCreateApiEndPointTable(){
		...
		$this->table('ApiEndPoint', array('id'=> false, 'primary_key' => array('id')))
			...
			->addColumn('sResponseExemple',     'string',       array('null'    => true,     'length' => 1073741823 ))
	...
	protected function vCreateApiVersionTable(){
		...
		$this->table('ApiVersion', array('id'=> false, 'primary_key' => array('id')))
			...
			->addColumn('sInfo',                'string',       array('null'   => true, 'length' => 1073741823 ))
			->addColumn('sDataToServerExample', 'string',       array('null'   => true, 'length' => 1073741823 ))
			->addColumn('aPossibleHttp',        'string',       array('null'   => true, 'length' => 1073741823 ))
			->addColumn('aGetParams',           'string',       array('null'   => true, 'length' => 1073741823 ))
