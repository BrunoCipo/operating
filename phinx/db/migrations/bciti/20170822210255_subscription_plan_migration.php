...
class SubscriptionPlanMigration extends AbstractMigration
{
	...
	private function vCreateSubscriptionRecurrencePLan(){
		...
		$this->table('SubscriptionPlanRecurrence', [ 'id'=> false, 'primary_key' => [ 'id' ] ] )
			...
			->addColumn('sPurchasePriceTaxList',        'string',       [ 'null'    => false,   'length' => 1073741823 ] )
			...
			->addColumn('sRenewalPriceTaxList',         'string',       [ 'null'    => false,   'length' => 1073741823 ] )
			->addColumn('bRenewalIsAvailable',          'integer',      [ 'null'    => false ] )
			->addColumn('iMaxRenewal',                  'integer',      [ 'null'    => false ] )
			->addColumn('sPaymentMethodList',           'string',       [ 'null'    => false,   'length' => 1073741823 ] )
			->addColumn('sPaymentTermList',             'string',       [ 'null'    => false,   'length' => 1073741823 ] )
